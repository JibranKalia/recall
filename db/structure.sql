...
CREATE UNIQUE INDEX "index_token_usages_on_message_id" ON "token_usages" ("message_id");
...
CREATE UNIQUE INDEX "index_session_sources_on_session_id" ON "session_sources" ("session_id");
...
CREATE INDEX "index_sessions_on_project_id" ON "sessions" ("project_id");
CREATE INDEX "index_sessions_on_started_at" ON "sessions" ("started_at");
CREATE UNIQUE INDEX "index_sessions_on_external_id" ON "sessions" ("external_id");
...
CREATE UNIQUE INDEX "index_message_contents_on_message_id" ON "message_contents" ("message_id");
...
CREATE INDEX "index_messages_on_session_id_and_position" ON "messages" ("session_id", "position");
...
CREATE TABLE IF NOT EXISTS "projects" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "path" varchar NOT NULL, "sessions_count" integer DEFAULT 0 NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "domain" varchar DEFAULT 'personal' NOT NULL);
CREATE UNIQUE INDEX "index_projects_on_path" ON "projects" ("path");
...
CREATE INDEX "index_experiment_runs_on_experiment_id" ON "experiment_runs" ("experiment_id");
...
CREATE INDEX "index_experiments_on_session_id" ON "experiments" ("session_id");
...
CREATE INDEX "index_import_runs_on_status" ON "import_runs" ("status");
CREATE INDEX "index_import_runs_on_completed_at" ON "import_runs" ("completed_at");
...
CREATE INDEX "index_session_summaries_on_session_id" ON "session_summaries" ("session_id");
CREATE INDEX "index_session_summaries_on_experiment_run_id" ON "session_summaries" ("experiment_run_id");
...
CREATE UNIQUE INDEX "index_session_tombstones_on_external_id" ON "session_tombstones" ("external_id");
